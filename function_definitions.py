...
class YoLov5TRT(object):
    ...
    def infer(self, raw_image_generator):
        ...
        overlap_road,overlap_footpath = 0,0
        resultant_prediction = ' '
        # Do postprocess
        for i in range(self.batch_size):
            ...
            overlap_road = (intersection/total)*100
            ...
            overlap_footpath = (intersectionf/totalf)*100
            
            resultant_prediction = ' '
            if overlap_road > 30:
                resultant_prediction = 'Road'
            elif overlap_footpath > 30:
                resultant_prediction = 'Footpath'
        ...
        return batch_image_raw, end - start, overlap_road, overlap_footpath, resultant_prediction
...
class YoloTRT():
    ...
    def Inference(self, img):
        ...
        cuda.memcpy_htod_async(cuda_inputs[0], host_inputs[0], stream)
        ppend = time.time()
        #print(f'Total preprocessing time: {ppend - ppstart}')
        t1 = time.time()
        ...
        pop2 = time.time()
        print(f'Postprocessing TIme: {pop2 - pop1}')
...
'''
Code section for classification
'''
...
cls_classes = ['Footpath', 'Road', 'Other']
...
class CustomYoloClass(object):
    ...
    def infer(self, raw_image_generator):
        ...
        return batch_image_raw,classes_ls, end - start
    ...
    def postprocess_cls(self, output_data):
        ...
        for ind in range(index.shape[0]):
            ...
            classes_ls.append(cls_classes[input_category_id])
